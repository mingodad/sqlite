...
# define RTREE_ZERO 0
  ...
  typedef sqlite_float RtreeValue;                /* Low accuracy coordinate */
# define RTREE_ZERO LITDBL(0.0)
#endif
...
*/
#define RNDTOWARDS  ((sqlite_double)(1.0 - 1.0/8388608.0))  /* Round towards zero */
#define RNDAWAY     ((sqlite_double)(1.0 + 1.0/8388608.0))  /* Round away from zero */
...
static RtreeValue rtreeValueDown(sqlite3_value *v){
  ...
  sqlite_float f = (sqlite_float)d;
  if( f>d ){
    f = (sqlite_float)(d*(d<0 ? RNDAWAY : RNDTOWARDS));
  }
  return f;
}
static RtreeValue rtreeValueUp(sqlite3_value *v){
  ...
  sqlite_float f = (sqlite_float)d;
  if( f<d ){
    f = (sqlite_float)(d*(d<0 ? RNDTOWARDS : RNDAWAY));
  }
  return f;
}
