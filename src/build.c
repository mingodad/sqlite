...
void sqlite3PreparedBeginParse(
  Parse *pParse,        /* Parsing context */
...
void sqlite3PreparedArgInit(Parse *pParse){
}

void sqlite3PreparedArgExtend(Parse *pParse, Token *p){
}

void sqlite3PreparedFinishParse(Parse *pParse, Token *pEnd){
}

void sqlite3PreparedExecute(Parse *pParse, Token *pName){
}

void sqlite3PreparedDeallocate(Parse *pParse, Token *pName, int ifExists){
}
